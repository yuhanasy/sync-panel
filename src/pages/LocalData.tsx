...
export function LocalData() {
  ...
  const resetUserDirtyFields = useLocalEntityStore(
    (s) => s.resetUserDirtyFields,
  );
  const resetDoorDirtyFields = useLocalEntityStore(
    (s) => s.resetDoorDirtyFields,
  );
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600 mt-1">
          Manage local entities. Edited fields are marked with an amber
          indicator.
        </p>
      </div>
                    ...
                    >
                      ...
                      editingCell?.field === field ? (
                        <input
                          ...
                          className="w-full px-2 py-1 rounded text-xs focus:outline-none focus:ring-2 focus:ring-gray-400"
                        />
                      ) : (
                      ...
                      >
                        ...
                        editingCell?.field === field ? (
                          <input
                            ...
                            className="w-full px-2 py-1 border border-blue-400 rounded text-xs focus:outline-none focus:ring-2 focus:ring-gray-400"
                          />
                        ) : (
                          <div className="flex items-center gap-2">
                            <span className="cursor-pointer hover:underline">
